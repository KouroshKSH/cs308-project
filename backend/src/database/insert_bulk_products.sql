...
('SN13', 'Wrist Watch', 'Premium wrist watch', 60.00, 1, 17, 'Steel', 'url_SN13', 30, 'Lifetime', 'DistJ', RAND() * 10), -- category_id: 17 (Watches)
...
('SN23', 'Light Wash Jeans', 'Light wash skinny denim jeans', 45.99, 2, 9, 'Denim', 'url_SN23', 250, '2 Years', 'DistD', RAND() * 10), -- category_id: 9 (Jeans)
